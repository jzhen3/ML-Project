...
## Updata
The goal of this project to predict and recommend what films the user may like via building a Films' recommendation system. This project is an important work because it can help films companies, like Netflix, to develop more potential customers and their potential purchasing power. In addition, consumers can also be benefits from the system because they save their time form seaching information of films or other services. 
